...
classes = [
	["高等数学A(上)", "郑继明", "必修", "5.5", "3403", "A15191A1110010033", [2] + rgWeek(5, 18), 1, rgWeek(3, 4)],
	["C语言程序设计", "纪良浩", "必修", "3.0", "2117", "A15191A1040040010", [2] + [5] + rgWeek(7, 19), 1, rgWeek(5, 6)],
	["线性代数A", "张蓉", "必修", "3.0", "3401", "A15191A1110030014", [2] + rgWeek(5, 15), 2, rgWeek(1, 2)],
	["综合英语1", "邱怡", "必修", "2.0", "5205", "A15191A2051090006", [2] + rgWeek(5, 19), 2, rgWeek(5, 6)],
	["托福A", "杨紫凌（外聘）", "选修", "6.0", "5305", "A15191A2150210002", [2] + rgWeek(5, 19), 2, rgWeek(9, 11)],
	["工程英语", "程方", "必修", "2.0", "5305", "A15191A2011200001", [2] + rgWeek(5, 19), 3, rgWeek(3, 4)],
	["高等数学A(上)", "郑继明", "必修", "5.5", "3403", "A15191A1110010033", [2] + rgWeek(5, 18), 3, rgWeek(7, 8)],
	...
	["线性代数A", "张蓉", "必修", "3.0", "3401", "A15191A1110030014", [2] + rgWeek(5, 15), 4, rgWeek(5, 6)],
	["托福A", "熊阳（外聘）", "选修", "6.0", "5305", "A15191A2150210002", [2] + rgWeek(5, 19), 4, rgWeek(9, 11)],
	["高等数学A(上)", "郑继明", "必修", "5.5", "3403", "A15191A1110010033", [2] + rgWeek(5, 17), 5, rgWeek(3, 4)],
...
X-APPLE-STRUCTURED-LOCATION;VALUE=URI;X-APPLE-MAPKIT-HANDLE=;X-APPLE-RADIUS=500;X-TITLE=重庆邮电大学
 综合实验大楼\\""" + "\\n南山路新力村:geo:29.524289,106.605595"""
	else: customGEO = """LOCATION:重庆邮电大学-国际学院\\n崇文路2号重庆邮电大学内
X-APPLE-STRUCTURED-LOCATION;VALUE=URI;X-APPLE-MAPKIT-HANDLE=;X-APPLE-RADIUS=500;X-TITLE=重庆邮电大学
