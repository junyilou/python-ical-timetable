...
classes = [
	["大学物理A(下)", "刘俊(理)", "2315", "A15201A1110300012", rgWeek(1, 16), 1, [9, 10]],
	...
	["微处理器(美方授课)", "Yangjie", "电子系统综合设计实验室2YF312", "AS15201A2011220001", rgWeek(1, 16), 2, [5, 6]],
	["微处理器(美方授课)", "Yangjie", "电子系统综合设计实验室2YF312", "AS15201A2011220001", rgWeek(1, 16), 2, [7, 8]],
	["电路理论及应用I(美方授课)", "杜佳佳", "5404", "A15201A2021300001", rgWeek(1, 12), 3, [1, 2]],
	["电路理论及应用I(美方授课)", "杜佳佳", "5404", "A15201A2021300001", rgWeek(1, 12), 3, [3, 4]],
	["大学物理A(下)", "刘俊(理)", "2315", "A15201A1110300012", oeWeek(1, 15, 1), 3, [5, 6]],
	...
	["大学生职业发展与就业指导1", "邹桦", "5401", "A15201B1220060061", rgWeek(1, 8), 5, [7, 8]]
]
