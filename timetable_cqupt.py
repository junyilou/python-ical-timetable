...
classes = [
	["高等数学A(下)", "郑继明", "5401", "A15192A1110020040", rgWeek(1, 15), 1, [1, 2]],
	["形势与政策", "严常青", "5305", "A15192A1100010064", rgWeek(5, 8), 1, [5, 6]],
	["数据结构与算法B", "黎贵友", "智能科学与技术实验室(综合实验楼B515)", "SK15192A2040481001", rgWeek(9, 16), 1, [5, 6]],
	["思想政治理论课实践教学", "孙璐", "4212", "S15192A1100060070", [2], 1, rgWeek(7, 8)],
	["大学物理实验A(上)", "虚拟教师", "物理实验室（一）(综合实验楼C201/C202)", "S15192A2110670018", [12], 1, [9, 10]],
	["大学物理实验A(上)", "虚拟教师", "物理虚拟仿真实验室(综合实验楼C314/C315/C316)", "S15192A2110670018", [9], 1, [9, 10]],
	["大学物理实验A(上)", "虚拟教师", "光学设计性实验室(综合实验楼C312/C313)", "S15192A2110670018", [8], 1, [9, 10]],
	["大学物理实验A(上)", "虚拟教师", "电学设计性实验室(综合实验楼C310/C311)", "S15192A2110670018", [6], 1, [9, 10]],
	["大学物理实验A(上)", "虚拟教师", "物理实验室（四）(综合实验楼C209/C210)", "S15192A2110670018", [5], 1, [9, 10]],
	["大学物理实验A(上)", "虚拟教师", "物理实验室（二）(综合实验楼C203/C204)", "S15192A2110670018", [1, 3, 14], 1, [9, 10]],
	["数字逻辑基础(美方授课)", "黄沛昱", "5203", "A15192A2021330001", rgWeek(1, 12), 2, [9， 10]],
	["大学体育2", "分配教师", "运动场1", "A00192A1090020001", rgWeek(1, 16), 2, [5, 6]],
	["数字逻辑基础(美方授课)", "朱治国", "电子技术实验室（一）(综合实验楼B201/B202)", "SK15192A2021330001", rgWeek(2, 9), 3, [3, 4]],
	["大学物理A(上)", "刘俊（理）", "5402", "A15192A1110290011", rgWeek(1, 16), 3, [1, 2]],
	["高等数学A(下)", "郑继明", "5401", "A15192A1110020040", rgWeek(1, 15), 3, [5, 6]],
	["数据结构与算法B", "张璞", "5200", "A15192A2040481001", rgWeek(1, 16), 3, [9, 10]],
	["数字逻辑基础(美方授课)", "黄沛昱", "5203", "A15192A2021330001", rgWeek(1, 12), 4, [1, 2]],
	["思想道德修养与法律基础", "张冬梅", "5305", "A15192A1100021011", rgWeek(1, 16), 4, [5, 6, 7]],
	["高等数学A(下)", "郑继明", "5401", "A15192A1110020040", rgWeek(1, 15), 5, [3, 4]],
	["大学物理A(上)", "刘俊（理）", "5402", "A15192A1110290011", oeWeek(2, 16, 0), 5, [7, 8]]
]
