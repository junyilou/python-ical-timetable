...
classes = [
	...
	["C语言程序设计", "纪良浩", "必修", "3.0", "2117", "A15191A1040040010", [2] + rgWeek(7, 18), 1, rgWeek(5, 6)],
	["线性代数A", "张蓉", "必修", "3.0", "3401", "A15191A1110030014", [2, 6, 7] + rgWeek(9, 15), 2, rgWeek(1, 2)],
	["大学体育1-足球二班", "张文", "必修", "1.0", "运动场1", "A00191A1090010001", [2] + rgWeek(6, 18), 2, rgWeek(3, 4)],
	["综合英语1", "邱怡", "必修", "2.0", "5205", "A15191A2051090006", [2] + rgWeek(6, 17), 2, rgWeek(5, 6)],
	["托福A", "杨紫凌（外聘）", "选修", "6.0", "5305", "A15191A2150210002", [2] + rgWeek(6, 18), 2, rgWeek(9, 11)],
	["工程英语", "程方", "必修", "2.0", "5305", "A15191A2011200001", [2] + rgWeek(7, 18), 3, rgWeek(3, 4)],
	...
	["托福A", "熊阳（外聘）", "选修", "6.0", "5305", "A15191A2150210002", [2] + rgWeek(6, 18), 4, rgWeek(9, 11)],
	["高等数学A(上)", "郑继明", "必修", "5.5", "3403", "A15191A1110010033", [2] + rgWeek(5, 9) + rgWeek(11, 17), 5, rgWeek(3, 4)],
